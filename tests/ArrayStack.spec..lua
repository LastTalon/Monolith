...
return function()
	...
	describe("Constructor", function()
		...
		it("should error when attempting to create a stack from a non-table", function()
			expect(function() ArrayStack.new(true) end).to.throw(
				"Cannot construct ArrayStack from type boolean.")
			expect(function() ArrayStack.new(1) end).to.throw(
				"Cannot construct ArrayStack from type number.")
			expect(function() ArrayStack.new("string") end).to.throw(
				"Cannot construct ArrayStack from type string.")
			expect(function() ArrayStack.new(function() end) end).to.throw(
				"Cannot construct ArrayStack from type function.")
			expect(function() ArrayStack.new(Instance.new("Folder")) end)
				.to.throw("Cannot construct ArrayStack from type userdata.")
			expect(function() ArrayStack.new(
		...
		describe("Optional Methods", function()
			...
			describe("Remove", function()
				it("should successfully attempt to remove when empty", function()
					local stack = ArrayStack.new()
					expect(function() stack:Remove(1) end).never.to.throw()
				end)
			...
			describe("RetainAll", function()
				it("should successfully attempt to retain when empty", function()
					...
					expect(function() stack:RetainAll(retain) end).never.to.throw()
				end)
