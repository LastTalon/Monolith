...
return function()
	...
	describe("Constructor", function()
		...
		it("should error when attempting to create a list from a non-table", function()
			expect(function() ArrayList.new(true) end).to.throw(
				"Cannot construct ArrayList from type boolean.")
			expect(function() ArrayList.new(1) end).to.throw(
				"Cannot construct ArrayList from type number.")
			expect(function() ArrayList.new("string") end).to.throw(
				"Cannot construct ArrayList from type string.")
			expect(function() ArrayList.new(function() end) end).to.throw(
				"Cannot construct ArrayList from type function.")
			expect(function() ArrayList.new(Instance.new("Folder")) end)
				.to.throw("Cannot construct ArrayList from type userdata.")
			expect(function() ArrayList.new(
